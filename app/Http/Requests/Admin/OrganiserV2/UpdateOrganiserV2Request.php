...
namespace App\Http\Requests\Admin\OrganiserV2;

use Illuminate\Contracts\Validation\Validator;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Http\Exceptions\HttpResponseException;

class UpdateOrganiserV2Request extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'organiser_category_id' => 'sometimes|nullable|integer|exists:organiser_categories,id',
            'organiser_subcategory_ids' => 'sometimes|nullable|array',
