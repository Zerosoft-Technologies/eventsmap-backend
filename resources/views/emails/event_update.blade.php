...
<head>
    ...
    <title>Event Updated - {{ $event->title }}</title>
    <style>
...
<body>
    <div class="card">
        ...
        <p>The event <strong>{{ $event->title }}</strong> has been updated by {{ $actor->name ?? 'the event publisher' }}.</p>
        ...
        <p>Please review the updated details in your invitations on The Events Map.</p>
